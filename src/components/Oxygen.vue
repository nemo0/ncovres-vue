                ...
                <div class="table-wrapper">
                    <table>
                        ...
                        <tbody v-if="err === false">
                            <tr v-for="supplier in oxygenSupplier" v-bind:key="supplier.id">
                                <td>{{supplier.name}} <span v-if="supplier.verified"><img src="images/verified.png" alt="" srcset="" class="verified"></span></td>
    ...
    export default {
        ...
        methods: {
            async onChange(e) {
                ...
                try {
                    const res = await axios.get(`http://localhost:5000/api/v1/oxygen/${e.target.value}`)
